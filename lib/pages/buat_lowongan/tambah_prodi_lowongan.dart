...
class TambahProdiLowongan extends StatefulWidget {
  const TambahProdiLowongan({super.key});

  @override
  State<TambahProdiLowongan> createState() => _TambahProdiLowonganState();
}

class _TambahProdiLowonganState extends State<TambahProdiLowongan> {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            onPressed: () {
              Navigator.pushReplacementNamed(context, '/tambah_jurusan');
            },
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            if (_formKey.currentState!.validate()) {
                              Navigator.pushNamed(context, '/tambah_tingkat');
                            }
                          },
                          style: ButtonStyle(
