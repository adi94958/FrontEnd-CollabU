...
class _EditPengalamanState extends State<EditPengalaman> {
  ...
  final dateMasukController = TextEditingController(text: 'Januari 2023');
  final dateBerakhirController = TextEditingController(text: 'Agustus 2023');
  final posisiController = TextEditingController(text: 'Manager');
  final perusahaanController = TextEditingController(text: 'Amazon Inc');
