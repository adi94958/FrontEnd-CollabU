...
class TambahJurusan extends StatefulWidget {
  const TambahJurusan({super.key});

  @override
  State<TambahJurusan> createState() => _TambahJurusanState();
}

class _TambahJurusanState extends State<TambahJurusan> {
